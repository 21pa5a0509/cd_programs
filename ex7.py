{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNUAHQtwf0Pgs+e/2fCJby3",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/21pa5a0509/cd_programs/blob/main/ex7.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "_BUliL75hWsD",
        "outputId": "c7034a40-1729-41c7-c74d-aabb5a6fff21"
      },
      "outputs": [
        {
          "output_type": "stream",
