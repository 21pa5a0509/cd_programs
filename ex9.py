{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPBteiKFvqjZS7ByWz62iMg",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/21pa5a0509/cd_programs/blob/main/ex9.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "Zf21NEpRiFcE",
        "outputId": "2adedd5b-6e3e-42bb-e550-688cce1d47bd"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "Goto(I0,a):{('C', 'a.C'), ('C', '.d'), ('C', '.aC')} That is I2\n",
            "Goto(I0,S):{(\"S'\", 'S.')} That is I3\n",
            "Goto(I0,C):{('S', 'C.C'), ('C', '.d'), ('C', '.aC')} That is I4\n",
            "Goto(I2,d):{('C', 'd.')} That is I1\n",
            "Goto(I2,a):{('C', 'a.C'), ('C', '.d'), ('C', '.aC')} That is I2\n",
            "Goto(I2,C):{('C', 'aC.')} That is I5\n",
            "Goto(I4,d):{('C', 'd.')} That is I1\n",
            "Goto(I4,a):{('C', 'a.C'), ('C', '.d'), ('C', '.aC')} That is I2\n",
