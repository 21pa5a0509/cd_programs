{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOXNOICXQICtvff7wHHHgEN",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/21pa5a0509/cd_programs/blob/main/ex2.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "zyyLuJmjeXJM",
        "outputId": "eb635395-c88a-4970-d71d-766201f84e8b"
      },
      "outputs": [
        {
          "output_type": "stream",
